  ...
  public function center(): array {
    ...
    $build = [
      ...
      'content' => [
        ...
        'intro' => ['#markup' => '<p class="brebo-help__intro">Vind uitleg over schermen, BREBO-processen, rollen en dagelijkse taken. Zoek op een handeling, begrip, rol of onderdeel van Office.</p>'],
        'search' => [
          '#type' => 'inline_template',
          '#template' => '<form class="brebo-help__search" method="get"><label class="visually-hidden" for="brebo-help-search">Zoeken in Help</label><input id="brebo-help-search" name="q" type="search" value="{{ query }}" placeholder="Bijv. projectleider, offerte, uitklokken"><button type="submit">Zoeken</button></form>',
          '#context' => ['query' => $query],
        ],
      ],
    ];
