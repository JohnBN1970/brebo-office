...
/** Receives authenticated documents from BREBO website journeys. */
final class WebsiteDocumentIntakeController extends ControllerBase {
  ...
  public function upload(Request $request): JsonResponse {
    ...
    $directory = 'private://brebo-intake/website/' . $requestId;
