...
/** Receives authenticated external project documents into central intake. */
final class ExternalProjectDocumentController extends ControllerBase {
  ...
  public function upload(Request $request): JsonResponse {
    ...
    if (!preg_match('/^brebo-platform\.[a-z0-9._-]+$/', $source)) {
      return $this->error(422, 'invalid_source');
    }

    $directory = 'private://brebo-intake/external/' . $requestId;
    ...
    $intake = $this->intakeManager->intake([
      ...
      'classification' => 'external_project_request',
      'confidence' => 1.0,
      'canonical' => [],
      'payload' => [
        'api_version' => '1',
