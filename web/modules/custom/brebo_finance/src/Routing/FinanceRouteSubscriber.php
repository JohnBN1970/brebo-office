...
final class FinanceRouteSubscriber extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection): void {
    ...
    $routes = [
      ...
      'brebo_finance.cashflow_management' => new Route('/brebo-office/finance/cashflow-management', ['_controller' => '\\Drupal\\brebo_finance\\Controller\\CashFlowManagementController::page', '_title' => 'Cashflow & managementrapportage'], ['_permission' => 'approve brebo finance'], ['no_cache' => TRUE], '', [], ['GET']),
      'brebo_finance.sales_settings' => new Route('/brebo-office/finance/sales/settings', ['_controller' => '\\Drupal\\brebo_finance\\Controller\\SalesSettingsRedirectController::salesSettings', '_title' => 'Verkoopinstellingen'], ['_custom_access' => '\\Drupal\\brebo_finance\\Access\\SalesSettingsAccess::access'], ['no_cache' => TRUE], '', [], ['GET']),
      ...
      'brebo_finance.sales_standalone_release' => new Route('/brebo-office/finance/sales/drafts/{draft}/release', ['_form' => '\\Drupal\\brebo_finance\\Form\\StandaloneSalesInvoiceReleaseForm', '_title' => 'Factuur definitief vrijgeven'], ['_permission' => 'access brebo finance'], ['no_cache' => TRUE], '', [], ['GET', 'POST']),
