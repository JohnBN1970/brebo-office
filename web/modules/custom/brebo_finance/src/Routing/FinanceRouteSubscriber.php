...
final class FinanceRouteSubscriber extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection): void {
    ...
    $routes = [
      ...
      'brebo_finance.sales_settings' => new Route('/brebo-office/finance/sales/settings', ['_controller' => '\\Drupal\\brebo_finance\\Controller\\SalesSettingsRedirectController::redirect', '_title' => 'Verkoopinstellingen'], ['_custom_access' => '\\Drupal\\brebo_finance\\Access\\SalesSettingsAccess::access'], ['no_cache' => TRUE], '', [], ['GET']),
