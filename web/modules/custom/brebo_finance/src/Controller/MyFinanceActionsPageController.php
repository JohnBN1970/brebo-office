...
final class MyFinanceActionsPageController extends ControllerBase {
  public function page(): array {
    return [
      ...
      'header' => ['#markup' => '<header class="bmfa-header"><div><span class="bmfa-kicker">BREBO OFFICE · PERSOONLIJKE COCKPIT</span><h1>Mijn Werkbak</h1><p>Alles wat vandaag jouw aandacht nodig heeft.</p></div><a href="/brebo-office/finance">Financieel Command Center</a></header>'],
