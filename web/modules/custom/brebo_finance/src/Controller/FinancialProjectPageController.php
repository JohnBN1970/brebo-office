...
final class FinancialProjectPageController extends ControllerBase {
  public function __construct(private readonly EntityTypeManagerInterface $financeEntityTypeManager) {}
  ...
  public function page(int $project_nid): array {
    $project=$this->financeEntityTypeManager->getStorage('node')->load($project_nid); if($project===NULL||$project->bundle()!=='brebo_project') throw new NotFoundHttpException('BREBO project does not exist.'); if(!$project->access('view',$this->currentUser())) throw new AccessDeniedHttpException('No access to this BREBO project.');
