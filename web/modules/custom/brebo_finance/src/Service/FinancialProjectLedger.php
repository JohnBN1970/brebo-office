...
final class FinancialProjectLedger {
  ...
  private function performanceReceipts(int $projectNid): array {
    ...
    if($schema->tableExists('brebo_building_object')){$q->leftJoin('brebo_building_object','o','o.id = l.object_id');$q->addField('o','object_code');$q->addField('o','label','object_label');$q->addField('o','object_type');}
