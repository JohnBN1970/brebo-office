...
final class GlassPositionOverviewController extends ControllerBase {
  ...
  public function overview(): array {
    ...
    $projectRisk=$this->projectRiskAggregator->aggregate($positions);
    $projectRows=[];
    foreach($projectRisk as$project){
      $projectId=(int)$project['project_nid'];
      $projectRows[]=[
    ...
    $build['projects']=['#type'=>'table','#caption'=>$this->t('Projectimpact glas'),'#header'=>[$this->t('Project'),$this->t('Niveau'),$this->t('Impact'),$this->t('Max. vertraging'),$this->t('Belangrijkste oorzaak')],'#rows'=>$projectRows,'#empty'=>$this->t('Geen projectgebonden glasrisico’s gevonden.')];
