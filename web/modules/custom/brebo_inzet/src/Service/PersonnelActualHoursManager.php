...
final class PersonnelActualHoursManager {
  ...
  public function returnForCorrection(NodeInterface $assignment, int $userId): int {
    ...
    if ($submitted === NULL || $submitted['status'] !== 'worked') {
      throw new \UnexpectedValueException('Only submitted hours can be returned for correction.');
    }
    ...
    return $this->labourProductivity->synchronizeEntry(
      ...
      NULL, '0.0000', 'cancelled', time(), [
        ...
        'evidence' => 'submitted_hours_returned',
      ], $userId,
    );
  }
