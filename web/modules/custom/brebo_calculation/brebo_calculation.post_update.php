...
function brebo_calculation_post_update_add_object_source_traceability(&$sandbox = NULL): string {
  ...
  if (!$schema->tableExists($table)) {
    return 'BREBO Calculation row domain is not installed; no source traceability fields added.';
  }
  $fields = [
  ...
  return $added
    ? 'BREBO Calculation object source traceability added: ' . implode(', ', $added) . '.'
    : 'BREBO Calculation object source traceability already exists.';
}
