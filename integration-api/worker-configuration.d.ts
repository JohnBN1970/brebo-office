...
interface __BaseEnv_Env {
	API_VERSION: "1.2.0-draft";
	WORKER_VERSION: "0.3.0";
	OFFICE_PUBLICATION_BASE_URL: "https://sboffice.brebobv.nl";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_VERSION" | "WORKER_VERSION" | "OFFICE_PUBLICATION_BASE_URL" | "OPENAI_MODEL" | "MAX_INPUT_CHARS" | "MAX_BODY_BYTES" | "MAX_CLOCK_SKEW_SECONDS" | "REPLAY_TTL_SECONDS" | "OUTBOUND_IDEMPOTENCY_TTL_SECONDS" | "OPENAI_TIMEOUT_MS" | "OPENAI_MAX_OUTPUT_TOKENS" | "RATE_WINDOW_SECONDS" | "MAX_ANALYSES_PER_WINDOW" | "MONTHLY_TOKEN_BUDGET" | "MONEYBIRD_ADMINISTRATION_ID" | "MONEYBIRD_ACCESS_TOKEN" | "ABN_AMRO_PAYMENT_ENDPOINT" | "ABN_AMRO_INSIGHT_BASE_URL" | "ABN_AMRO_ACCESS_TOKEN" | "ABN_AMRO_API_KEY" | "OPENAI_API_KEY" | "BREBO_SHARED_SECRET">> {}
}
